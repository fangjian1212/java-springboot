package com.fangjian.framework.utils.excel.jxls2;

import com.fangjian.framework.utils.excel.jxls2.command.EachCommand;
import com.fangjian.framework.utils.excel.jxls2.command.ImageCommand;
import com.fangjian.framework.utils.excel.jxls2.command.LinkCommand;
import com.fangjian.framework.utils.excel.jxls2.command.MergeCommand;
 ...
 * @date: Create in 16:41 2017/12/14
 * @modified by:
 */
public class JxlsUtil {
     ...
     * jxls模版文件目录
     */
    private final static String TEMPLATE_PATH = "templates/exportTemplates";
    ...
    public static InputStream getTemplateAsStream(String name) {
        InputStream inputStream = JxlsUtil.class.getClassLoader().getResourceAsStream(TEMPLATE_PATH + "/" + name);
        if (null != inputStream) {
            return inputStream;
        }
        return null;
