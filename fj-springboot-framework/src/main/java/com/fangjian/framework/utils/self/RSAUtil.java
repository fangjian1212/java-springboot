...
public class RSAUtil {
	 ...
	 * @throws Exception
	 */
	public final static byte[] decryptByPrivateKey(byte[] encryptedData, String privateKey) throws Exception {
	 ...
	 * @throws Exception
	 */
	public final static byte[] decryptByPublicKey(byte[] encryptedData, String publicKey) throws Exception {
	 ...
	 * @throws Exception
	 */
	public final static String decryptByPrivateKey(String encryptedData, String privateKey) throws Exception {
	 ...
	 * @throws Exception
	 */
	public final static String decryptByPublicKey(String encryptedData, String publicKey) throws Exception {
	 ...
	 * @throws Exception
	 */
	public final static String encryptByPublicKey(String data, String publicKey) throws Exception {
	 ...
	 * @throws Exception
	 */
	public final static String encryptByPrivateKey(String data, String privateKey) throws Exception {
